...
*/
    ...
    Random r=new Random();
    int x=r.nextInt(stanza.length);
    int y=r.nextInt(stanza.length);
    ImageView skin;
    ...
    public void muovi() {
        ...
        if(posizioneOminoY==y && posizioneOminoX==x){
            skin.setAlpha(1f);
        }else{
            skin.setAlpha(0f);
        }
        ...
        if (ominoY >= altezzaFrame - omino.getWidth() / 4)
            ominoY = altezzaFrame - omino.getWidth() / 4;
    ...
    public void creaFragment(int animazione) {
        ...
        skin.setX(r.nextInt(1080));
        skin.setY(r.nextInt(( 1584 - 1321)+1321));
